...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Druva Yarlagadda"
  # s.authors            = { "Druva Yarlagadda" => "druva.yarlagadda@valuelabs.com" }
  # s.social_media_url   = "http://twitter.com/Druva Yarlagadda"
  ...
  s.source = { :path =>'~/Volumes/DriveA/code/Personal/snippet/ios/Swift/pods-swift/firstpod/testcore/MobiCoreFramework/' }
